<?php
	...
	if (!isset($_SESSION['zalogowany']) || $_SESSION['punkty']<500)
	{
...
<html lang="en">
	<head>
		<title>MyBookMarks.Eu - Get Vip</title>
		<meta charset="UTF-8">
		<meta name="viewport" content="initial-scale=1.0">
		<meta name="author" content="Rafał Podraza">
		<meta name="description" content="Get a reward for your points!">
		<meta name="keywords" content="get,rewards, your points, free">
               ...
               <div class="container paddingS1">
                   <div class="row">
                    ...
                    <p>After the purchase will log out</p>
                        ...
                        <form class="form-horizontal" action='finishvip.php' method="POST">
			  <fieldset>
			    <div id="legend">
			      <legend class=""></legend>
			    </div>
